...
def get_args():
    ...
    parser.add_argument(
        "--filepath_to_arguments_json_file", nargs="?", type=str, default=None, help=""
    )
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=False,
        help="A flag indicating whether to execute script in eval or training mode",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Model to use for the eval experiments",
    )
